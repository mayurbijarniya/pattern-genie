  ...
  const supportOptions = [
    {
      ...
      action: () => window.open("https://github.com/mayurbijarniya/pattern-genie", "_blank")
    },
    {
      icon: Coffee,
    ...
    },
    {
      ...
      action: () => window.open("https://github.com/mayurbijarniya/pattern-genie/issues", "_blank")
    },
    {
      icon: MessageCircle,
      title: "Feedback",
      description: "Share your thoughts and suggestions",
      action: () => window.open("https://github.com/mayurbijarniya/pattern-genie/discussions", "_blank")
    }
  ];
        ...
        <div className="mb-4 bg-card border border-border rounded-lg shadow-lg p-4 w-64">
          <div className="space-y-3">
            <div className="flex items-center justify-between mb-3">
              <h3 className="font-semibold text-foreground">Support Pattern Genie</h3>
